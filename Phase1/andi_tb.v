...
// andi R7, R4, 0x71 => R7 <- R4 & sign_extend(0x71)
// Initialize: R4 = 0xF0
// Expected: R7 = 0xF0 & 0x71 = 0111_0000 = 0x00000070
//
// Uses 4-step fetch: RAM[0] preloaded with ANDI_INSTR so IR loads naturally.
...
module andi_tb;
    ...
    // andi R7, R4, 0x71: IR[26:23]=Ra=7, IR[22:19]=Rb=4, IR[18:0]=C=0x71
    // opcode bits[31:27] = 00100
    localparam [31:0] ANDI_INSTR = 32'h23A00071;

    // Control Sequence: andi (4-step fetch)
    ...
    // Preload RAM[0] with the andi instruction; set R4 after clear deasserts.
    initial begin
        DUT.mem_sys.ram_inst.memory[9'h000] = ANDI_INSTR;
        #25;
    ...
    always @(*) begin
        ...
        case (Present_state)
            ...
            T5: begin // Cout, AND, Zin
                Cout = 1; ALUop = ALU_AND; Zin = 1;
            end
