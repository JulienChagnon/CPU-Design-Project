...
// ldi R7, 0x65 => R7 <- sign_extend(0x65) = 0x00000065
// R0 is used as base (BAout gates 0 onto bus regardless of R0 contents).
// No memory access: result is the immediate constant itself.
// Expected: R7 = 0x00000065
...
module ldi_tb;
    ...
    // ldi R7, 0x65: IR[26:23]=Ra=7, IR[22:19]=Rb=0, IR[18:0]=C=0x65
    // opcode bits[31:27] = 00001 (ldi)
    localparam [31:0] LDI_INSTR = 32'h0B800065;
    ...
    // Preload RAM[0] with ldi instruction; no register preload needed (Rb=R0).
    initial begin
