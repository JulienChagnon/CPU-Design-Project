...
// ldi R0, 0x72(R2) => R0 <- R2 + sign_extend(0x72) = 0x57 + 0x72 = 0xC9
// R2 is initialized to 0x57; no memory access occurs.
// Expected: R0 = 0x000000C9
...
module ldi_tb2;
    ...
    // ldi R0, 0x72(R2): IR[26:23]=Ra=0, IR[22:19]=Rb=2, IR[18:0]=C=0x72
    // Effective value: R2 + 0x72 = 0x57 + 0x72 = 0xC9
    // opcode bits[31:27] = 00001 (ldi)
    localparam [31:0] LDI_INSTR = 32'h08100072;

    // Control Sequence: ldi (4-step fetch, no IR force)
    ...
    // Preload RAM[0] with ldi instruction; set R2 after clear deasserts.
    initial begin
        DUT.mem_sys.ram_inst.memory[9'h000] = LDI_INSTR;
        #25;
